...
const formats = [
    ...
    { format: 'iife', platform: "browser", sourcemap: false, outfile: 'dist/midi-audio-player.js' },
    { format: 'iife', platform: "browser", sourcemap: false, minify: true, outfile: 'dist/midi-audio-player.min.js' },
